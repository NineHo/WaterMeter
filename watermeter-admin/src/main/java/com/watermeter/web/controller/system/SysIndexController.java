...
import com.watermeter.common.core.domain.entity.SysMenu;
import com.watermeter.common.core.domain.entity.SysUser;
import com.watermeter.common.core.text.Convert;
import com.watermeter.common.utils.CookieUtils;
...
//        return "visable";
//    }
    @GetMapping("/system/visable")
    public String visable(ModelMap mmap)
    {
        mmap.put("version", RuoYiConfig.getVersion());
        return "visable";
    }
